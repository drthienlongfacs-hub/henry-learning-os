...
const IPA_DB: Record<string, string> = {
  ...
  'left': '/lɛft/', 'above': '/əˈbʌv/', 'below': '/bɪˈloʊ/',
  'forwards': '/ˈfɔːrwərdz/', 'backwards': '/ˈbækwərdz/',
  'straight': '/streɪt/',
  ...
  'touch': '/tʌtʃ/', 'taste': '/teɪst/', 'smell': '/smɛl/',
