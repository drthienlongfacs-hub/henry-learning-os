...
export const PRIMARY_CURRICULUM_TOPIC_MAP: PrimaryCurriculumTopicMap[] = [
    ...
    vietnamese(4, 'writing_g4', 'Tập làm văn', 'Viết', 'Viết bài văn tả (người, cảnh, đồ vật) có cấu trúc Mở - Thân - Kết và biện pháp tu từ.', 'Con viết mở bài giới thiệu người cần tả, dùng so sánh hoặc nhân hóa ở thân bài.', ['Thiếu cấu trúc 3 phần', 'Không dùng biện pháp tu từ nào']),
    vietnamese(5, 'writing_g5', 'Nghị luận đơn giản', 'Viết', 'Viết bài nghị luận có ý kiến, lý lẽ và dẫn chứng.', 'Con nêu ý kiến về việc đọc sách, đưa ra 2 lý do và một ví dụ cụ thể.', ['Chỉ nêu ý kiến mà không có dẫn chứng', 'Nhầm nghị luận với kể chuyện']),
