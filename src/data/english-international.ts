...
export const CAMBRIDGE_UNITS: CountryUnit[] = [
  ...
  { unitId: 'cam_g1_u08', grade: 1, unitNumber: 8, title: 'Things that have happened', titleVi: 'Những điều đã xảy ra', framework: 'cambridge' },
  { unitId: 'cam_g1_u09', grade: 1, unitNumber: 9, title: 'Poems and rhymes on a theme', titleVi: 'Thơ và vần theo chủ đề', framework: 'cambridge' },
  { unitId: 'cam_g2_u01', grade: 2, unitNumber: 1, title: 'Stories about things we know', titleVi: 'Truyện về những điều quen thuộc', framework: 'cambridge' },
  { unitId: 'cam_g2_u02', grade: 2, unitNumber: 2, title: 'How to write instructions', titleVi: 'Cách viết hướng dẫn', framework: 'cambridge' },
  { unitId: 'cam_g2_u03', grade: 2, unitNumber: 3, title: 'Poems and rhymes about places and people we know', titleVi: 'Thơ và vần về nơi chốn và con người quen thuộc', framework: 'cambridge' },
  { unitId: 'cam_g2_u04', grade: 2, unitNumber: 4, title: 'Stories from around the world with a tale to tell', titleVi: 'Truyện từ khắp thế giới có bài học', framework: 'cambridge' },
  { unitId: 'cam_g2_u05', grade: 2, unitNumber: 5, title: 'What is my house made of?', titleVi: 'Ngôi nhà của tôi làm bằng gì?', framework: 'cambridge' },
  { unitId: 'cam_g2_u06', grade: 2, unitNumber: 6, title: 'Poems by famous poets', titleVi: 'Thơ của các nhà thơ nổi tiếng', framework: 'cambridge' },
  { unitId: 'cam_g2_u07', grade: 2, unitNumber: 7, title: 'Stories by famous writers', titleVi: 'Truyện của tác giả nổi tiếng', framework: 'cambridge' },
  { unitId: 'cam_g2_u08', grade: 2, unitNumber: 8, title: 'Things under the sea', titleVi: 'Những thứ dưới biển', framework: 'cambridge' },
  { unitId: 'cam_g2_u09', grade: 2, unitNumber: 9, title: 'All kinds of creatures', titleVi: 'Đủ loại sinh vật', framework: 'cambridge' },
  { unitId: 'cam_g3_u01', grade: 3, unitNumber: 1, title: 'Ordinary days', titleVi: 'Ngày thường', framework: 'cambridge' },
  { unitId: 'cam_g3_u02', grade: 3, unitNumber: 2, title: "Let's have a party!", titleVi: 'Hãy mở tiệc nào!', framework: 'cambridge' },
  { unitId: 'cam_g3_u03', grade: 3, unitNumber: 3, title: 'See, hear, feel, enjoy', titleVi: 'Nhìn, nghe, cảm nhận, thưởng thức', framework: 'cambridge' },
  ...
  { unitId: 'cam_g3_u06', grade: 3, unitNumber: 6, title: 'Poems from around the world', titleVi: 'Thơ từ khắp thế giới', framework: 'cambridge' },
  ...
  { unitId: 'cam_g4_u06', grade: 4, unitNumber: 6, title: 'Sensational poems', titleVi: 'Thơ ấn tượng', framework: 'cambridge' },
  ...
  { unitId: 'cam_g4_u09', grade: 4, unitNumber: 9, title: 'Poems to ponder', titleVi: 'Thơ để suy ngẫm', framework: 'cambridge' },
