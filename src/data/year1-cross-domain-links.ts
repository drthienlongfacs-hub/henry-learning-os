...
export const CROSS_DOMAIN_LINKS: CrossDomainLink[] = [
  ...
  },
  {
    ...
    connections: [
      ...
      { subject: 'math', topicId: 'ma10_1', relevance: 'Recognise UK coins', relevanceVi: 'Nhận biết tiền xu Anh' },
      { subject: 'math', topicId: 'ma10_1b', relevance: 'Recognise Vietnamese banknotes', relevanceVi: 'Nhận biết tiền Việt Nam' },
      { subject: 'math', topicId: 'ma10_3', relevance: 'Shopping word problems', relevanceVi: 'Bài toán mua sắm' },
    ],
    suggestedActivity: 'Set up a pretend shop with UK and VN prices. Label items: "Apple — 5p / 5.000đ". Practice buying in both currencies.',
    suggestedActivityVi: 'Lập cửa hàng giả với giá Anh và Việt. Ghi giá mỗi món: "Táo — 5p / 5.000đ". Thực hành mua bán bằng cả hai loại tiền.',
  },
  {
