...
const HIST_G4_QS = [
    { q: 'Nhà nước đầu tiên của nước ta tên là gì?', a: 'Văn Lang', opts: ['Văn Lang', 'Âu Lạc', 'Đại Việt', 'Đại Ngu'], e: 'Nhà nước Văn Lang do các vua Hùng lập ra, là nhà nước đầu tiên của người Việt.', illustration: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Dong_Son_bronze_drum_2.jpg/800px-Dong_Son_bronze_drum_2.jpg' },
    ...
    { q: 'Ai là người lãnh đạo nhân dân đánh đuổi quân Nam Hán trên sông Bạch Đằng năm 938?', a: 'Ngô Quyền', opts: ['Ngô Quyền', 'Lý Thường Kiệt', 'Trần Hưng Đạo', 'Lê Lợi'], e: 'Năm 938, Ngô Quyền dùng cược gỗ cắm dưới sông Bạch Đằng, đánh tan quân Nam Hán.', illustration: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/TranBinhTrong_TuUyen.jpg/800px-TranBinhTrong_TuUyen.jpg' },
    { q: 'Cổ Loa là kinh đô của triều đại nào?', a: 'Âu Lạc', opts: ['Âu Lạc', 'Văn Lang', 'Đại Cồ Việt', 'Đại Việt'], e: 'An Dương Vương lập ra nước Âu Lạc, đóng đô ở Cổ Loa (Đông Anh, Hà Nội nay).', illustration: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/90/Matbangcoloa.jpg/800px-Matbangcoloa.jpg' },
    ...
    { q: 'Cuộc khởi nghĩa Hai Bà Trưng nổ ra vào năm nào?', a: 'Năm 40', opts: ['Năm 40', 'Năm 248', 'Năm 938', 'Năm 981'], e: 'Mùa xuân năm 40, Hai Bà Trưng (Trưng Trắc, Trưng Nhị) phất cờ khởi nghĩa ở Mê Linh.', illustration: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5f/Dong_Ho_painting_-_Hai_Ba_Trung.jpg/800px-Dong_Ho_painting_-_Hai_Ba_Trung.jpg' },
...
const GEO_QS = [
    { q: 'Núi cao nhất Việt Nam tên là gì?', a: 'Fansipan', opts: ['Fansipan', 'Bạch Mã', 'Lang Biang', 'Ngọc Linh'], e: 'Đỉnh Fansipan cao 3.143m, được mệnh danh là "nóc nhà Đông Dương".', illustration: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/Fansipan-01.jpg/800px-Fansipan-01.jpg' },
    { q: 'Thủ đô của nước ta là?', a: 'Hà Nội', opts: ['Hà Nội', 'TP. Hồ Chí Minh', 'Đà Nẵng', 'Huế'], e: 'Hà Nội là thủ đô, trung tâm chính trị, văn hóa của nước Việt Nam.', illustration: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e6/Hanoi_city_view_from_Lotte_Center.jpg/800px-Hanoi_city_view_from_Lotte_Center.jpg' },
    { q: 'Sông nào lớn nhất miền Nam nước ta?', a: 'Sông Cửu Long (Mê Kông)', opts: ['Sông Cửu Long (Mê Kông)', 'Sông Sài Gòn', 'Sông Đồng Nai', 'Sông Hồng'], e: 'Sông Cửu Long chảy qua 6 nước, đổ ra biển Đông qua 9 cửa ở đồng bằng Nam Bộ.', illustration: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/Mekong_River_Delta.jpg/800px-Mekong_River_Delta.jpg' },
    { q: 'Đất nước Việt Nam có hình dạng giống chữ cái nào?', a: 'Chữ S', opts: ['Chữ S', 'Hình vuông', 'Hình tròn', 'Hình tam giác'], e: 'Việt Nam nằm trải dài dọc bờ biển Đông, uốn cong theo hình chữ S.', illustration: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/07/Vietnam_in_Asia_%28-mini_map_-rivers%29.svg/800px-Vietnam_in_Asia_%28-mini_map_-rivers%29.svg.png' },
    ...
    { q: 'Thành phố lớn nhất nước ta về dân số và kinh tế?', a: 'TP. Hồ Chí Minh', opts: ['TP. Hồ Chí Minh', 'Hà Nội', 'Hải Phòng', 'Cần Thơ'], e: 'TP. Hồ Chí Minh là trung tâm kinh tế năng động và đông dân nhất cả nước.', illustration: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Ho_Chi_Minh_City_Skyline_%28Night%29.jpg/800px-Ho_Chi_Minh_City_Skyline_%28Night%29.jpg' },
