...
const ECO_QS = [
    { q: 'Chuỗi thức ăn bắt đầu từ đâu?', a: 'Thực vật (sinh vật sản xuất)', opts: ['Thực vật (sinh vật sản xuất)', 'Động vật ăn thịt', 'Vi khuẩn', 'Con người'], e: 'Thực vật quang hợp tạo năng lượng → cơ sở chuỗi thức ăn.' },
    { q: 'Ô nhiễm không khí chủ yếu do đâu?', a: 'Khí thải xe cộ và nhà máy', opts: ['Khí thải xe cộ và nhà máy', 'Cây cối', 'Nước biển', 'Gió'], e: 'Đốt nhiên liệu hóa thạch → CO2, SO2, bụi mịn → ô nhiễm.' },
    { q: '3R là viết tắt của gì?', a: 'Reduce - Reuse - Recycle', opts: ['Reduce - Reuse - Recycle', 'Run - Read - Rest', 'Red - Round - Right', 'Rain - River - Rock'], e: 'Giảm thiểu - Tái sử dụng - Tái chế: 3 nguyên tắc bảo vệ môi trường.' },
    { q: 'Rừng cung cấp gì cho con người và động vật?', a: 'Oxy, thức ăn, nơi ở, gỗ', opts: ['Oxy, thức ăn, nơi ở, gỗ', 'Chỉ gỗ', 'Chỉ oxy', 'Không cung cấp gì'], e: 'Rừng là "lá phổi xanh": tạo O2, giữ nước, chống xói mòn, là nơi ở của động vật.' },
    { q: 'Nước sạch dùng cho sinh hoạt chiếm bao nhiêu % nước trên Trái Đất?', a: 'Khoảng 1%', opts: ['Khoảng 1%', 'Khoảng 50%', 'Khoảng 30%', 'Khoảng 10%'], e: '97% nước biển mặn, 2% đóng băng ở cực, chỉ ~1% nước ngọt dùng được.' },
    { q: 'Tuyệt chủng nghĩa là gì?', a: 'Loài đó hoàn toàn biến mất', opts: ['Loài đó hoàn toàn biến mất', 'Di cư sang nơi khác', 'Ngủ đông', 'Thay đổi hình dạng'], e: 'Tuyệt chủng = không còn cá thể nào sống sót. VD: khủng long.' },
];
