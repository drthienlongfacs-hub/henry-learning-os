...
def replace_in_file(filepath):
    ...
    # Regex to capture wiki urls and their filenames
    # Example: 'https://upload.wikimedia.org/wikipedia/commons/thumb/.../filename'
    ...
    for filename, url in urls.items():
        content = content.replace(url, f"/images/core/{filename}")
        
    with open(filepath, 'w') as f:
        f.write(content)
    print(f"Replaced inside {filepath}")

replace_in_file('src/lib/content/math-generator.ts')
replace_in_file('src/lib/content/vietnamese-generator.ts')
